#
#  Be sure to run `pod spec lint YJDownloadManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/feng562925462/YJDownloadManager.git", :tag => s.version }
  ...
  s.source_files  = "YJDownloadManagerDemo/YJDownloadManagerDemo/Classes/*.{h,m}"
